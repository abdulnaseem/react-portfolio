      ...
      <div className="container pb-3 ps-3 pe-3 rounded" id="projects">
        ...
        <div className="p-1 my-3 border" id="individual">
          <div className="col text-center">
            <h4>Pain Management Report (Dissertation)</h4>
          </div>
          <p className="p-3">
            ...
            <ul>
              ...
              <li>Have also utilised Unity platform to test and display the 3D human anatomy upon failure.</li>
              <li>Core tools & technologies:
                <ul>
                  <li>Java | XML | Java with SQLite | Android | OpenGL-ES API | Unity</li>
                </ul>
              </li>
            </ul>
          </p>
        ...
        <div className="p-1 my-3 border" id="individual">
          ...
          <p className="p-3">
            ...
            <ul>
              ...
              <li>Utilized Power Shell scripting to execute and test the program.</li>
              <li>Core tools & technologies:
                <ul>
                  <li>Java | Concurrency | Multi-Threading (Multi Client-Server Communication) | Locking</li>
                </ul>
              </li>
        ...
        <div className="p-1 my-3 border" id="individual">
          <div className="col text-center">
            <h4>ParkNow <br />(Android Application)</h4>
          </div>
          <p className="p-3">
            ...
            each sprint was evaluated before moving onto the next. And was assigned to a particular member of the group.
            ...
            <ul>
              ...
              <li>Solution (app): Explore neighbouring parking space made available by rentors and become a rentee for the desired time limit.</li>
              <li>Core responsibilities, tools & technologies:
                <ul>
                  <li>Booking activity | Front-end Development | Android development | Git | XML | Java | NoSql (Firebase database) | Google Maps API</li>
                </ul>
              </li>
            </ul>
          </p>
        ...
        <div className="p-1 my-3 border" id="individual">
          <div className="col text-center">
            <h4>Vending Machine for Custom-Printing Books 'On Demand' (Prototype)</h4>
          </div>
          <p className="p-3">
          ...
          <div className="col text-center pt-1">
            <button id="button" className="btn btn-primary btn-md" onClick={() => handleClick('https://marvelapp.com/prototype/10b70ea9')}>MarvelApp</button>
          </div>
        </div>
        ...
        <div className="p-1 my-3 border" id="individual">
          ...
          <p className="p-3">
            This was my first introduction to android development where I have created an android application that allows a user to type a number from 1-6,
            and click a button that generates a random number from 1-6 also. If the user's number and the random generator match then the user gets a point.
            Also, introducing to different activities where a user clicks a button and is navigated to a new activity.
          </p>
          <div className="col text-center pt-1">
            <button id="button" className="btn btn-primary btn-md" type="button" onClick={() => handleClick('https://github.com/abdulnaseem/diceroller')}>GitHub</button>
          </div>
        </div>
        ...
        <div className="p-1 my-3 border" id="finch-robot">
          ...
          <div className="col text-center pt-1">
            <button id="button" className="btn btn-primary btn-md" type="button" onClick={() => handleClick('https://github.com/abdulnaseem/finchrobot-tiltcontrol')}>GitHub</button>
          </div>
        </div>
